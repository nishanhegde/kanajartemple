...
<body onload="window.print()">
	...
	<div id="page-wrap">
		...
		<table id="expensetable">
			...
			<tr>
				<td id="expenserecno">${Expense.recNo}</td>

				<td>&nbsp</td>
				<td id="expensetdate">${tdate}</td>
			</tr>
			<tr>
				<td id="title" colspan="3">${Expense.title}</td>
			</tr>
			<tr>
				<td id="description" colspan="3">${Expense.description}</td>
			...
			<tr>
				...
				<td id="expensesignature">${Signature}</td>
				<td>&nbsp</td>
				<td></td>
			</tr>
			<tr>
